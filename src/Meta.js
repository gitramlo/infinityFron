...
const Meta = () => {
  ...
  <div className='buttontxt d-flex ml-5 mt-5'>
        <button type="button" class="btn btn-warning activebtn" style={{height:'30'}}>Ended</button>
  <img src="data:image/png;base64," class="img-fluid ml-2 logoimgs" alt="Responsive image"></img>
 </div>
